...
# 起動前に自動マイグレーションを実行
CMD bash -c "php /var/www/html/startup_migrate.php && php -d display_errors=1 -d error_reporting=E_ALL -d upload_max_filesize=12M -d post_max_size=40M -d max_file_uploads=20 -S 0.0.0.0:\${PORT:-8080} -t /var/www/html /var/www/html/router.php"
