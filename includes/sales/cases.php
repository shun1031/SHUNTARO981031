...
function createSalesCase(int $companyId, array $data): int {
    ...
    foreach (['case_name', 'carrier', 'trade_name', 'recruitment_count', 'new_transactions', 'negotiations_count', 'contracts_count', 'case_division', 'budget_division',
                 'sales_rep_id', 'manager_id', 'recruiter_id', 'worker_employee_id'] as $col) {
