...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .step-dot.active { background: linear-gradient(135deg, #2563eb, #60a5fa); width: 48px; }
        ...
        .btn-outline-success { color: #2563eb; border-color: #3b82f6; border-radius: 10px; padding: 10px; font-weight: 500; font-size: .9rem; }
        .btn-outline-success:hover { background: #2563eb; border-color: #2563eb; color: #fff; }
        ...
        .login-brand-icon { width: 36px; height: 36px; border-radius: 10px; background: linear-gradient(135deg, #2563eb, #60a5fa); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 1rem; box-shadow: 0 4px 14px rgba(37,99,235,.2); }
