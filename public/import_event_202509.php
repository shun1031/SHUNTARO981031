<?php
/**
 * 【一度だけ実行するスクリプト】2025年9月 イベント案件 データ投入
 *
 * スプレッドシートの「2025年9月イベント稼働分」46件をイベント案件として登録します。
 *
 ...
 *     元データの売上・原価・粗利・粗利率と全46行で一致することを確認済み。
 *   - 開始日・終了日は日付そのまま（常勤は月単位）。開始日〜終了日の日数＝稼働日数も全行一致。
 *   - イベント案件に光ADの項目は無い。屋号は元データに列が無いため空欄。
 *   - 同じスタッフが月内に何度も稼働するため、二重登録チェックは「スタッフ名＋開始日」で行う。
 *
 * 常勤と同じ扱い:
 *   - 管理者・採用者の「該当者なし」は空欄にして直営業扱いにする。
 *   - 営業担当の柴田盛満は名簿の営業マンではないため「直営業」にする（1件）。
 *     「直営業」は集計側が認識する値で、インセンティブ率は0%、ダッシュボードでも専用に集計される。
 *   - 区分は全件「2次以降」。予算区分は1次のときだけの項目なので設定なし。
 *   - キャリア列は SB / au なのでそのままキャリアへ。
 */
...
//     7開始日 8終了日 9キャリア 10店舗名 11請求単価(日) 12支払単価(日) 13稼働日数
$DATA = [
    // 河野夢大: 元データの営業担当は柴田盛満だが、名簿の営業マンではないため直営業にする（ユーザー指示）
    ['kunitoko asset','直営業','','名倉雅貴','アルバイト','','河野夢大','2025-09-20','2025-09-21','au','コジマ鳴海',18000,11560,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','橋本勝','2025-09-02','2025-09-08','SB','西尾シャオ',35000,29000,7],
    ['ラネット','近藤航','竹内陽','','アライアンス','T-Group','橋本勝','2025-09-16','2025-09-16','SB','西尾シャオ',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','橋本勝','2025-09-17','2025-09-17','SB','Tポート',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','橋本勝','2025-09-19','2025-09-24','SB','Tポート',35000,29000,6],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','橋本海','2025-09-02','2025-09-08','SB','西尾シャオ',35000,29000,7],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','橋本海','2025-09-17','2025-09-24','SB','Tポート',35000,29000,8],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','橋本海','2025-09-27','2025-09-28','SB','ドンキ刈谷',35000,29000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','中村翼','2025-09-02','2025-09-02','SB','西尾シャオ',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','渡部政幸','2025-09-03','2025-09-03','SB','西尾シャオ',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','矢野太雅','2025-09-04','2025-09-04','SB','西尾シャオ',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','矢野太雅','2025-09-20','2025-09-23','SB','西尾シャオ',35000,29000,4],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','矢野太雅','2025-09-27','2025-09-28','SB','ドンキ刈谷',35000,29000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','今井翼','2025-09-05','2025-09-07','SB','西尾シャオ',35000,29000,3],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','今井翼','2025-09-13','2025-09-13','SB','GA知立',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','今井翼','2025-09-15','2025-09-15','SB','GA知立',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','今井翼','2025-09-18','2025-09-18','SB','GA知立',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','今井翼','2025-09-21','2025-09-23','SB','Tポート',35000,29000,3],
    ['ラネット','竹内陽','','','アライアンス','T-Group','西山累司','2025-09-06','2025-09-08','SB','西尾シャオ',35000,29000,3],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','藤田淳也','2025-09-13','2025-09-16','SB','GA知立',30000,22500,4],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','藤田淳也','2025-09-22','2025-09-24','SB','Tポート',35000,29000,3],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','西山累司','2025-09-17','2025-09-18','SB','西尾シャオ',35000,29000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','小笠原藍','2025-09-13','2025-09-23','SB','GA知立',35000,29000,11],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','多湖竜星','2025-09-05','2025-09-07','SB','ピアゴ福釜',35000,29000,3],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','多湖竜星','2025-09-17','2025-09-18','SB','西尾シャオ',35000,29000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','後藤翔太','2025-09-14','2025-09-14','SB','GA知立',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','力武龍太','2025-09-13','2025-09-15','SB','GA知立',35000,29000,3],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','力武龍太','2025-09-22','2025-09-23','SB','西尾シャオ',35000,29000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','平林魁都','2025-09-05','2025-09-05','SB','西尾シャオ',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','平林魁都','2025-09-17','2025-09-19','SB','西尾シャオ',35000,29000,3],
    ['ラネット','竹内陽','','','アライアンス','T-Group','河合龍太郎','2025-09-19','2025-09-19','SB','西尾シャオ',35000,29000,1],
    ['ラネット','竹内陽','竹内陽','竹内陽','アライアンス','渡邊拓斗','渡邉拓斗','2025-09-06','2025-09-07','SB','GA知立',35000,30000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','渡邉拓斗','2025-09-20','2025-09-23','SB','GA知立',35000,30000,4],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','渡邉拓斗','2025-09-26','2025-09-28','SB','GA知立',35000,30000,3],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','山本美香','2025-09-06','2025-09-07','SB','GA知立',35000,30000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','稲田勇人','2025-09-06','2025-09-07','SB','GA知立',35000,30000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','稲田勇人','2025-09-20','2025-09-21','SB','GA知立',35000,30000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','稲田勇人','2025-09-27','2025-09-28','SB','GA知立',35000,30000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','小森美奈','2025-09-06','2025-09-10','SB','GA知立',30000,25500,5],
    ['ラネット','竹内陽','竹内陽','','正社員','','近藤航','2025-09-19','2025-09-20','SB','ドンキ刈谷',35000,0,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','青山','2025-09-20','2025-09-23','SB','GA知立',35000,30000,4],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','青山','2025-09-27','2025-09-27','SB','GA知立',30000,25500,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','金子','2025-09-22','2025-09-22','SB','GA知立',35000,30000,1],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','金子','2025-09-27','2025-09-28','SB','GA知立',35000,30000,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','石井','2025-09-22','2025-09-23','SB','GA知立',30000,25500,2],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','清水','2025-09-20','2025-09-22','SB','西尾シャオ',35000,29000,3],
];
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_event_202509 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_event_202509.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・キャリア列は <strong>SB・au</strong> なのでそのままキャリアへ。屋号は元データに列が無いため空欄<br>
      ・区分は全件<strong>2次以降</strong>（予算区分は1次のときだけの項目なので設定なし）<br>
      ・管理者・採用者の「該当者なし」は<strong>空欄（直営業）</strong>にして登録<br>
      ・営業担当の<strong>柴田盛満</strong>は名簿の営業マンではないため、営業担当を<strong>「直営業」</strong>にして登録（kunitoko asset／河野夢大の1件）<br>
    ...
    <table class="table table-sm table-hover bg-white mb-0">
      <thead class="table-light" style="position:sticky;top:0">
        <tr>
          ...
          <th>スタッフ</th><th>開始日</th><th>終了日</th><th>ｷｬﾘｱ</th><th>店舗</th><th class="text-end">稼働</th>
