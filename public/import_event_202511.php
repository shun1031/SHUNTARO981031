<?php
/**
 * 【一度だけ実行するスクリプト】2025年11月 イベント案件 データ投入
 *
 * スプレッドシートの「2025年11月イベント稼働分」31件をイベント案件として登録します。
 *
 ...
 *     元データの売上・原価・粗利・粗利率と全31行で一致することを確認済み。
 *   - 開始日・終了日は日付そのまま。開始日〜終了日の日数＝稼働日数も全行一致。
 *   - イベント案件に光ADの項目は無い。
 *   - 同じスタッフが月内に何度も稼働するため、二重登録チェックは「スタッフ名＋開始日」で行う。
 *
 * 11月分の読み替え（ユーザー確認済み）:
 *   - 店舗名の先頭の屋号を分ける。ED→ED、YAMADA西尾→YMD＋西尾、アピタ岩倉→AT＋岩倉。
 *     屋号が付いていない「岡崎本店」も同じ店舗なので屋号EDを補う。AM/GA は分けない。
 *   - スタッフ名「金子慶太」は9月・10月に登録済みの「金子」に合わせる（同一人物）。
 *   - ASXEED／近藤航の行は元データの空き列に 27000 が余分に入っているが、
 *     請求単価・支払単価・稼働日数は正しいのでそのまま登録する（余分な値は使わない）。
 *
 * 常勤・9-10月分と同じ扱い:
...
$DATA = [
    ['ホルドブレイ','竹内陽','','','正社員','','近藤航','2025-11-01','2025-11-03','SB','西尾',28000,0,3,'YMD'],
    ['アスカ','竹内陽','','','正社員','','近藤航','2025-11-08','2025-11-09','SB','AM茶屋',30000,0,2,''],
    ['アスカ','竹内陽','','','正社員','','近藤航','2025-11-15','2025-11-16','SB','AMドーム前',30000,0,2,''],
    ['アスカ','竹内陽','','','正社員','','近藤航','2025-11-22','2025-11-24','SB','AM茶屋',30000,0,3,''],
    ['ASXEED','近藤航','','','正社員','','近藤航','2025-11-29','2025-11-30','SB','一宮',27000,0,2,'ED'],
    ['kunitoko asset','名倉雅貴','','','アルバイト','','伊藤駿祐','2025-11-01','2025-11-03','au','岡崎本店',18000,10000,3,'ED'],
    ['kunitoko asset','名倉雅貴','','','アルバイト','','伊藤駿祐','2025-11-08','2025-11-09','au','岡崎本店',18000,10000,2,'ED'],
    ['kunitoko asset','名倉雅貴','','','アルバイト','','伊藤駿祐','2025-11-24','2025-11-24','au','豊田本店',18000,10320,1,'ED'],
    ['kunitoko asset','名倉雅貴','','','アルバイト','','河野夢大','2025-11-30','2025-11-30','au','豊橋ミラマチ',18000,11600,1,'ED'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','小木曽太一','2025-11-01','2025-11-03','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','小木曽太一','2025-11-08','2025-11-10','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','金子','2025-11-01','2025-11-03','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','金子','2025-11-22','2025-11-23','SB','GA知立',35000,30000,2,''],
    ['ホルドブレイ','竹内陽','竹内陽','','アライアンス','渡邊拓斗','金子','2025-11-24','2025-11-24','SB','岩倉',28000,25000,1,'AT'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','高橋翔','2025-11-01','2025-11-03','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','木村輝良','2025-11-01','2025-11-03','SB','GA知立',30000,25500,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','木村輝良','2025-11-08','2025-11-09','SB','GA知立',30000,25500,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','木村輝良','2025-11-15','2025-11-16','SB','GA知立',30000,25500,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','木村輝良','2025-11-22','2025-11-23','SB','GA知立',30000,25500,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','木村輝良','2025-11-29','2025-11-30','SB','GA知立',30000,25500,2,''],
    ['アスカ','竹内陽','','','自社外注','','東郷光啓','2025-11-22','2025-11-22','SB','AMドーム前',30000,0,1,''],
    ['アスカ','竹内陽','','','自社外注','','名倉雅貴','2025-11-23','2025-11-23','SB','AMドーム前',30000,0,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','鈴木勇太','2025-11-08','2025-11-09','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','山本蓮真','2025-11-08','2025-11-09','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','山本蓮真','2025-11-15','2025-11-16','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','鳩崎凌太','2025-11-29','2025-11-30','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','稲田勇人','2025-11-22','2025-11-24','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','渡邉拓斗','2025-11-16','2025-11-16','SB','GA知立',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','森尾柚木','2025-11-22','2025-11-23','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','長尾来樹','2025-11-28','2025-11-30','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','矢野成和','2025-11-29','2025-11-30','SB','GA知立',35000,30000,2,''],
];
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_event_202511 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_event_202511.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・店舗名の先頭に屋号が付いているものは<strong>屋号と店舗名に分けて登録</strong>（ED一宮→屋号ED＋店舗一宮、YAMADA西尾→YMD＋西尾、アピタ岩倉→AT＋岩倉／全7件）。AM・GA は分けません<br>
      ・屋号が付いていない<strong>「岡崎本店」</strong>も「ED岡崎本店」と同じ店舗として屋号EDを補いました<br>
      ・区分は全件<strong>2次以降</strong>（予算区分は1次のときだけの項目なので設定なし）<br>
      ・管理者・採用者の「該当者なし」は<strong>空欄（直営業）</strong>にして登録<br>
      ・スタッフ名<strong>「金子慶太」</strong>は9月・10月に登録済みの<strong>「金子」</strong>に合わせました（同一人物）<br>
      ・ASXEED／近藤航の行は元データの空き列に 27000 が余分に入っていますが、請求単価・支払単価・稼働日数は正常なのでそのまま登録します<br>
