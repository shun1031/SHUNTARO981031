<?php
/**
 * 【一度だけ実行するスクリプト】2025年12月 イベント案件 データ投入
 *
 * スプレッドシートの「2025年12月イベント稼働分」30件をイベント案件として登録します。
 *
 ...
 *     元データの売上・原価・粗利・粗利率と全30行で一致することを確認済み。
 *   - 開始日・終了日は日付そのまま。開始日〜終了日の日数＝稼働日数も全行一致。
 *   - イベント案件に光ADの項目は無い。
 *   - 同じスタッフが月内に何度も稼働するため、二重登録チェックは「スタッフ名＋開始日」で行う。
 *
 * 12月分の読み替え（ユーザー確認済み）:
 *   - 店舗名の先頭の屋号を分ける（ED安城→ED＋安城、KS大樹寺→KS＋大樹寺 など5種）。
 *     AM・GA は分けない。
 *   - スタッフ名「金子慶太」は9〜11月に登録済みの「金子」に合わせる（同一人物）。
 *
 * 常勤・9-11月分と同じ扱い:
 *   - 管理者・採用者の「該当者なし」は空欄にして直営業扱いにする。
 *   - 区分は全件「2次以降」。キャリア列（SB）はそのままキャリアへ。
 */
...
$DATA = [
    ['アスカ','竹内陽','','','正社員','','近藤航','2025-12-06','2025-12-07','SB','AMドーム前',30000,0,2,''],
    ['アスカ','竹内陽','','','正社員','','近藤航','2025-12-13','2025-12-14','SB','AM茶屋',30000,0,2,''],
    ['アスカ','竹内陽','','','正社員','','近藤航','2025-12-20','2025-12-21','SB','AM茶屋',30000,0,2,''],
    ['アスカ','竹内陽','','','正社員','','近藤航','2025-12-27','2025-12-28','SB','AM茶屋',30000,0,2,''],
    ['センターフロー','竹内陽','','','正社員','','近藤航','2025-12-30','2025-12-30','SB','豊橋',30000,0,1,'ED'],
    ['センターフロー','竹内陽','','','自社外注','','香川世舟','2025-12-25','2025-12-28','SB','岡崎本店',28000,0,4,'ED'],
    ['センターフロー','竹内陽','','','自社外注','','西山恭平','2025-12-25','2025-12-30','SB','安城',30000,0,6,'ED'],
    ['センターフロー','竹内陽','','','自社外注','','廣田晴哉','2025-12-25','2025-12-27','SB','岡崎本店',30000,0,3,'ED'],
    ['センターフロー','竹内陽','','','自社外注','','山崎慈英','2025-12-27','2025-12-29','SB','大樹寺',30000,0,3,'KS'],
    ['センターフロー','竹内陽','','','自社外注','','森岡裕貴','2025-12-25','2025-12-28','SB','安城',30000,0,4,'ED'],
    ['センターフロー','竹内陽','','','自社外注','','上村陸斗','2025-12-26','2025-12-30','SB','大樹寺',28000,0,5,'ED'],
    ['センターフロー','竹内陽','','','自社外注','','上床篤志','2025-12-26','2025-12-30','SB','岡崎本店',30000,0,5,'ED'],
    ['アスカ','竹内陽','','','自社外注','','綾部航介','2025-12-13','2025-12-13','SB','AMドーム前',30000,0,1,''],
    ['アスカ','竹内陽','','','自社外注','','小栗瑞貴','2025-12-14','2025-12-14','SB','AMドーム前',30000,0,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','金子','2025-12-06','2025-12-07','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','金子','2025-12-20','2025-12-21','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','森英章','2025-12-12','2025-12-14','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','山口海翔','2025-12-06','2025-12-07','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','小森美奈','2025-12-06','2025-12-07','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','碧山匠夏','2025-12-13','2025-12-14','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','碧山匠夏','2025-12-27','2025-12-28','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','稲田勇人','2025-12-13','2025-12-14','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','木村輝良','2025-12-23','2025-12-28','SB','GA知立',35000,30000,6,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','鳩崎凌太','2025-12-19','2025-12-21','SB','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','濱島慎介','2025-12-20','2025-12-21','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','高橋翔','2025-12-27','2025-12-28','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','山本蓮真','2025-12-27','2025-12-28','SB','GA知立',35000,30000,2,''],
    ['センターフロー','竹内陽','','','自社外注','','名倉雅貴','2025-12-31','2025-12-31','SB','安城',30000,0,1,'ED'],
    ['センターフロー','竹内陽','','','自社外注','','後藤太一','2025-12-26','2025-12-26','SB','豊橋',30000,0,1,'ED'],
    ['ホルドブレイ','竹内陽','竹内陽','','アライアンス','onetale','宮島涼','2025-12-27','2025-12-28','SB','ヨシヅヤ津島',22000,15000,2,''],
];
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_event_202512 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_event_202512.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・店舗名の先頭に屋号が付いているものは<strong>屋号と店舗名に分けて登録</strong>（ED安城→屋号ED＋店舗安城、KS大樹寺→KS＋大樹寺 など5種）。AM・GA は分けません<br>
      ・区分は全件<strong>2次以降</strong>（予算区分は1次のときだけの項目なので設定なし）<br>
      ・管理者・採用者の「該当者なし」は<strong>空欄（直営業）</strong>にして登録<br>
      ・スタッフ名<strong>「金子慶太」</strong>は9〜11月に登録済みの<strong>「金子」</strong>に合わせました（同一人物）<br>
