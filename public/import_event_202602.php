<?php
/**
 * 【一度だけ実行するスクリプト】2026年2月 イベント案件 データ投入
 *
 * スプレッドシートの「2026年2月イベント稼働分」71件をイベント案件として登録します。
 *
 ...
 *     元データの売上・原価・粗利・粗利率と全71行で一致することを確認済み。
 *   - 開始日・終了日は日付そのまま。開始日〜終了日の日数＝稼働日数も全行一致。
 *   - イベント案件に光ADの項目は無い。
 *   - 同じスタッフが月内に何度も稼働するため、二重登録チェックは「スタッフ名＋開始日」で行う。
 *
 * 2月分の読み替え（ユーザー確認済み）:
 *   - 営業担当の柴田盛満（3件）は名簿の営業マンではないため「直営業」にする（9月イベントと同じ）。
 *   - 佐藤悠太（2/21〜22）はアルバイト区分なので、外注先に入っていた「佐藤悠太」を空欄にする。
 *   - スタッフ名を既存の登録に合わせる:
 *     矢野大雅→矢野太雅、渡邊政幸→渡部政幸、安田祐希→安田裕希、金子慶太→金子、小川洸汰→小川洸太。
 *     ※角井しゅり／角井竣吏、渡邉空／渡邉晏 は別人なので統一しない。
 *   - 店舗名を既存の登録に合わせる:
 *     ヤマナカ 西枇杷島→ヤマナカ 西枇杷島店、MT大府→メガトラ大府、ららぽーと東郷→ららぽーと愛知東郷。
 *   - 屋号コード YM は既存の YMD に合わせる。
 *   - 店舗名の先頭の屋号を分ける（アピタ安城南→AT＋安城南）。AM・GA は分けない。
 *
 * 常勤・9-1月分と同じ扱い:
 *   - 管理者・採用者の「該当者なし」は空欄にして直営業扱いにする。
 *   - 区分は全件「2次以降」。コード列は SB のみキャリアへ、AM・ED・YMD は屋号へ。
 */
...
$DATA = [
    ['テレニシ','竹内陽','','','個人外注','','林航平','2026-02-02','2026-02-05','SB','モレラ岐阜',35000,0,4,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','角井しゅり','2026-02-02','2026-02-03','SB','モレラ岐阜',35000,25000,2,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','北岡空駆','2026-02-02','2026-02-03','SB','モレラ岐阜',35000,25000,2,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','渡邉空','2026-02-02','2026-02-05','SB','モレラ岐阜',30000,22000,4,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','河合温','2026-02-02','2026-02-02','SB','モレラ岐阜',30000,22000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','渡邊拓斗','笛吹佳暉','2026-02-02','2026-02-02','SB','モレラ岐阜',35000,30000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','渡邊拓斗','小野峻登','2026-02-02','2026-02-03','SB','モレラ岐阜',35000,30000,2,''],
    ['テレニシ','竹内陽','竹内陽','','アライアンス','渡邊拓斗','小川洸太','2026-02-02','2026-02-02','SB','モレラ岐阜',40000,34000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','矢野太雅','2026-02-03','2026-02-03','SB','モレラ岐阜',30000,22000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','渡邊拓斗','小川洸太','2026-02-03','2026-02-03','SB','モレラ岐阜',35000,30000,1,''],
    ['テレニシ','竹内陽','竹内陽','','アライアンス','渡邊拓斗','渡邉拓斗','2026-02-03','2026-02-05','SB','モレラ岐阜',40000,34000,3,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','内藤聖稀','2026-02-04','2026-02-05','SB','モレラ岐阜',35000,34000,2,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','矢野太雅','2026-02-04','2026-02-04','SB','モレラ岐阜',35000,25000,1,''],
    ['テレニシ','竹内陽','竹内陽','','アライアンス','魁組','風岡幸介','2026-02-04','2026-02-04','SB','モレラ岐阜',30000,22000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','渡邊拓斗','加藤蘭丸','2026-02-04','2026-02-04','SB','モレラ岐阜',35000,30000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','渡邊拓斗','金子','2026-02-04','2026-02-05','SB','モレラ岐阜',35000,30000,2,''],
    ['テレニシ','竹内陽','','','アライアンス','オアシス','北岡空駆','2026-02-05','2026-02-05','SB','モレラ岐阜',35000,25000,1,''],
    ['テレニシ','竹内陽','竹内陽','','アライアンス','魁組','河村圭吾','2026-02-05','2026-02-05','SB','モレラ岐阜',30000,22000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','渡邊拓斗','小野峻登','2026-02-05','2026-02-05','SB','モレラ岐阜',35000,30000,1,''],
    ['テレニシ','竹内陽','','','アライアンス','渡邊拓斗','渡邉拓斗','2026-02-21','2026-02-23','SB','モレラ岐阜',40000,34000,3,''],
    ['テレニシ','竹内陽','綾部航介','','アライアンス','高田夢斗','高田夢斗','2026-02-21','2026-02-23','SB','モレラ岐阜',35000,26000,3,''],
    ['テレニシ','竹内陽','綾部航介','','アライアンス','高田夢斗','藤吉太一','2026-02-21','2026-02-23','SB','モレラ岐阜',35000,26000,3,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','魁組','角井竣吏','2026-02-01','2026-02-01','','トナリエ四日市',35000,25000,1,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','オアシス','安田裕希','2026-02-01','2026-02-01','','トナリエ四日市',35000,25000,1,''],
    ['ベルパーク','竹内陽','竹内陽','','個人外注','','林航平','2026-02-07','2026-02-08','','トナリエ四日市',35000,0,2,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','オアシス','岩田宗士','2026-02-07','2026-02-08','','トナリエ四日市',35000,30000,2,''],
    ['ベルパーク','竹内陽','竹内陽','','個人外注','','林航平','2026-02-11','2026-02-11','','トナリエ四日市',35000,0,1,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','オアシス','内藤聖稀','2026-02-11','2026-02-11','','トナリエ四日市',35000,34000,1,''],
    ['ベルパーク','竹内陽','竹内陽','','個人外注','','林航平','2026-02-14','2026-02-15','','トナリエ四日市',35000,0,2,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','オアシス','内藤聖稀','2026-02-14','2026-02-15','','トナリエ四日市',35000,34000,2,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','オアシス','安田裕希','2026-02-21','2026-02-23','','トナリエ四日市',35000,25000,3,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','KTT','佐藤文哉','2026-02-21','2026-02-21','','トナリエ四日市',35000,25000,1,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','KTT','水谷翔','2026-02-22','2026-02-22','','トナリエ四日市',35000,25000,1,''],
    ['ベルパーク','竹内陽','竹内陽','','アライアンス','KTT','網代琉聖','2026-02-23','2026-02-23','','トナリエ四日市',35000,25000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','高橋翔','2026-02-01','2026-02-01','SB','GA知立',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','稲田勇人','2026-02-01','2026-02-01','SB','GA知立',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','碧山圭夏','2026-02-01','2026-02-01','SB','GA知立',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','碧山圭夏','2026-02-14','2026-02-15','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','森英章','2026-02-01','2026-02-01','SB','GA知立',30000,25500,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','中嶋幸樹','2026-02-07','2026-02-08','SB','GA知立',35000,25000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','豊田竜成','2026-02-07','2026-02-08','SB','GA知立',35000,25000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','沢崎寧央','2026-02-07','2026-02-08','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','小林美優','2026-02-07','2026-02-08','SB','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','渡部政幸','2026-02-14','2026-02-15','','そよら上飯田',35000,25000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','矢野太雅','2026-02-14','2026-02-15','','そよら上飯田',35000,25000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','矢野太雅','2026-02-21','2026-02-22','','ヤマナカ 西枇杷島店',35000,25000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','鳩崎凌太','2026-02-14','2026-02-14','','GA知立',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','渡邉拓斗','2026-02-15','2026-02-15','','GA知立',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','山本蓮真','2026-02-14','2026-02-15','','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','内藤聖稀','2026-02-18','2026-02-20','','岡崎',35000,34000,3,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','辻村杏慈','2026-02-18','2026-02-20','','岡崎',35000,30000,3,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','辻村杏慈','2026-02-27','2026-02-27','','メガトラ大府',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','牛島捷介','2026-02-18','2026-02-20','','岡崎',35000,30000,3,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','岩田宗士','2026-02-21','2026-02-23','','岡崎',35000,30000,3,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','岩田宗士','2026-02-27','2026-02-27','','安城南',35000,30000,1,'AT'],
    ['ラネット','竹内陽','竹内陽','','個人外注','','林航平','2026-02-21','2026-02-23','','岡崎',35000,25000,3,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','寺本飛悠','2026-02-21','2026-02-23','','岡崎',35000,25000,3,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','寺本飛悠','2026-02-27','2026-02-27','','安城南',35000,25000,1,'AT'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','渡邉晏','2026-02-21','2026-02-21','','岡崎',35000,25000,1,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','渡邉晏','2026-02-23','2026-02-23','','岡崎',35000,25000,1,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','船橋透志','2026-02-21','2026-02-23','','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','竹内陽','アライアンス','渡邊拓斗','船橋透志','2026-02-28','2026-02-28','','メガトラ大府',35000,30000,1,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','大町北斗','2026-02-21','2026-02-23','','GA知立',35000,30000,3,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','中島源内','2026-02-22','2026-02-22','','岡崎',35000,25000,1,'AM'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','森晴哉','2026-02-21','2026-02-22','','GA知立',35000,30000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','深江勇吾','2026-02-21','2026-02-22','','ヤマナカ 西枇杷島店',35000,25000,2,''],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','深江勇吾','2026-02-28','2026-02-28','','安城南',35000,25000,1,'AT'],
    ['kunitoko asset','直営業','','佐藤思杰','アルバイト','','佐藤悠太','2026-02-21','2026-02-22','','岡崎',18000,11800,2,'ED'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','オアシス','早川佳織','2026-02-28','2026-02-28','','安城南',35000,25000,1,'AT'],
    ['kunitoko asset','直営業','名倉雅貴','','アライアンス','onetale','古庄愛翔','2026-02-14','2026-02-15','','野並',18000,15000,2,'YMD'],
    ['kunitoko asset','直営業','名倉雅貴','','アライアンス','onetale','古庄愛翔','2026-02-23','2026-02-23','','ららぽーと愛知東郷',18000,15000,1,''],
];
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_event_202602 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_event_202602.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・コード列は <strong>SB</strong> のみキャリアへ、<strong>AM・ED・YMD は屋号</strong>へ（キャリアの選択肢に無いため）。空欄の行はどちらも空欄<br>
      ・屋号コードの <strong>YM</strong> は既存の <strong>YMD</strong> に揃えました<br>
      ・店舗名の先頭に屋号が付いているものは<strong>屋号と店舗名に分けて登録</strong>（アピタ安城南→屋号AT＋店舗安城南）。GA は分けません<br>
      ・区分は全件<strong>2次以降</strong>（予算区分は1次のときだけの項目なので設定なし）<br>
      ・管理者・採用者の「該当者なし」は<strong>空欄（直営業）</strong>にして登録<br>
      ・営業担当の<strong>柴田盛満</strong>（3件）は名簿の営業マンではないため<strong>「直営業」</strong>にしました（9月イベントと同じ）<br>
      ・<strong>佐藤悠太</strong>（2/21〜22）はアルバイト区分なので、外注先に入っていた「佐藤悠太」を<strong>空欄</strong>にしました<br>
      ・スタッフ名を既存の登録に合わせました（矢野大雅→<strong>矢野太雅</strong>、渡邊政幸→<strong>渡部政幸</strong>、安田祐希→<strong>安田裕希</strong>、金子慶太→<strong>金子</strong>、小川洸汰→<strong>小川洸太</strong>）。角井しゅり／角井竣吏、渡邉空／渡邉晏 は別人なのでそのままです<br>
      ・店舗名を既存の登録に合わせました（ヤマナカ 西枇杷島→<strong>ヤマナカ 西枇杷島店</strong>、MT大府→<strong>メガトラ大府</strong>、ららぽーと東郷→<strong>ららぽーと愛知東郷</strong>）<br>
