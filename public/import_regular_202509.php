<?php
/**
 * 【一度だけ実行するスクリプト】2025年9月 常勤案件 データ投入
 *
 * スプレッドシートの「2025年9月稼働分」34件を常勤案件として登録します。
 *
 ...
 *   - キャリア列は SB / docomo なのでそのままキャリアへ。
 *   - 今月は店舗名の先頭に屋号が付いているため（ED安城・YMD北方・Joshinカラフルタウン）、
 *     屋号と店舗名に分けて登録する。AM/AT/GA は他の月でも店舗名の一部なので分けない。
 *   - 稼働日数に 470000 が入っていた1件（プレイス／綾部航介／美濃加茂）は 21 に直す。
 ...
 *     備考に「稼働開始 YYYY/MM」として残す。開始月は全件 2025/09。
...
$DATA = [
    ['プレイス','竹内陽','綾部航介','','アライアンス','ASXEED','増岡あかり',21,'SB','ED','安城',420000,420000,0,'稼働開始 2025/09'],
    ['humanR','綾部航介','綾部航介','','アライアンス','NextAssist','浅井貴広',21,'docomo','YMD','北方',420000,399000,0,'稼働開始 2025/09'],
    ['LANGIS','竹内陽','','竹内陽','個人外注','','鈴木拓弥',21,'SB','','平針',462000,399000,0,'稼働開始 2025/09'],
    ['LANGIS','竹内陽','','','個人外注','','飛田拓斗',21,'SB','','AT各務原鵜沼',409500,315000,0,'稼働開始 2025/09'],
    ['LANGIS','竹内陽','','近藤航','自社外注','','丹後心来',21,'SB','','一宮開明',399000,250000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','綾部航介','','アライアンス','株式会社 樹','市川達雄',21,'SB','ED','安城',450000,420000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','鈴木真矢',21,'SB','ED','安城',450000,300000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','山根脩平',21,'SB','ED','安城',450000,300000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','西澤克輝',21,'SB','ED','安城',450000,300000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','後藤太一',21,'SB','ED','安城',450000,300000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','竹内陽','','アライアンス','T-Group','宮島航希',21,'SB','ED','豊田本店',385000,370000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','押野俊太郎',21,'SB','YMD','名本',450000,300000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','名倉雅貴',21,'SB','','GA知立',470000,300000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','佐藤思杰','自社外注','','綾部航介',21,'SB','','美濃加茂',470000,400000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','竹内丈治',21,'SB','','安城住吉',470000,330000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','正社員','','倉地樂',21,'SB','','安城',470000,0,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','自社外注','','東郷光啓',21,'SB','','碧南',470000,400000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','綾部航介','','アライアンス','ASXEED','山口大士',21,'SB','','AM豊川',470000,450000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','','正社員','','小栗瑞貴',21,'SB','','多治見南',470000,0,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','竹内陽','綾部航介','アライアンス','LaXum','大島那月',21,'SB','','岐阜芥見',470000,381000,0,'稼働開始 2025/09'],
    ['プレイス','竹内陽','','綾部航介','個人外注','','堀恭彰',21,'SB','JS','カラフルタウン',410000,315000,0,'稼働開始 2025/09'],
    ['プレイミー','名倉雅貴','','名倉雅貴','個人外注','','名倉雅貴',21,'SB','','半田亀崎',420000,336000,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','','','アライアンス','小林幹汰','長岡拓也',21,'SB','','AM豊川',525000,483000,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','','近藤航','自社外注','','清水一平',21,'SB','','碧南',504000,300000,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','','綾部航介','自社外注','','田中哲史',21,'SB','','碧南',483000,300000,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','','','自社外注','','田中敦之',21,'SB','','碧南',504000,330000,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','綾部航介','','アライアンス','ASXEED','吉川昇吾',21,'SB','','安城住吉',357000,336000,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','渡邉拓斗',39,'SB','','GA知立',975000,848250,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','竹内陽','','アライアンス','T-Group','石谷悠真',21,'SB','','知立',483000,357000,0,'稼働開始 2025/09'],
    ['ラネット','竹内陽','','','自社外注','','竹内陽',13,'SB','','中津川',520000,500000,0,'稼働開始 2025/09'],
    ['クラウドエージェント','竹内陽','竹内陽','','アライアンス','ネクストプレイス','石川海里',21,'SB','','長久手',378000,357000,0,'稼働開始 2025/09'],
    ['SNAP','竹内陽','','','自社外注','','彦田竣司',21,'SB','','豊田曙',525000,350000,0,'稼働開始 2025/09'],
    ['SNAP','竹内陽','','','自社外注','','山内文月',21,'SB','','豊田曙',483000,300000,0,'稼働開始 2025/09'],
    ['SNAP','竹内陽','','','自社外注','','安山祐亮',21,'SB','','豊田梅坪',378000,300000,0,'稼働開始 2025/09'],
];
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_regular_202509 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_regular_202509.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・キャリア列は <strong>SB・docomo</strong> なのでそのままキャリアへ<br>
      ・今月は店舗名の先頭に屋号が付いているため、<strong>屋号と店舗名に分けて登録</strong>（ED安城→屋号ED＋店舗安城、Joshinカラフルタウン→屋号JS＋店舗カラフルタウン／全10件）<br>
      ・稼働日数に <strong>470000</strong> が入っていた1件（プレイス／綾部航介／美濃加茂）は <strong>21</strong> に直しました<br>
      ・スタッフ区分の「外注」は<strong>個人外注</strong>として登録<br>
      ・区分は全件<strong>2次以降</strong>（予算区分は1次のときだけの項目なので設定なし）<br>
      ・元データ8列目の日付は<strong>稼働開始日</strong>なので、備考に「稼働開始 2025/12」の形で記録（開始月は全件2025/09）<br>
      ・管理者・採用者の「該当者なし」は<strong>空欄（直営業）</strong>にして登録（今月は多数の行にあります）<br>
      ・光ADチェックは全件OFF（元データに該当なし）<br>
  ...
  <div class="alert alert-warning small">
    ...
    <strong>登録後の注意：</strong>稼働日数が21未満の1件（竹内陽13日）は、
