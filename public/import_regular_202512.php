<?php
/**
 * 【一度だけ実行するスクリプト】2025年12月 常勤案件 データ投入
 *
 * スプレッドシートの「2025年12月稼働分」36件を常勤案件として登録します。
 *
 ...
 *     （元データの単価列は行によって日額と月額が混在していたため使わない）
 *   - ED/YMD/JS はキャリアの選択肢に無いので「屋号」へ。SB のみ「キャリア」へ。
 *   - スタッフ区分「外注」は「個人外注」として登録。
 *   - 区分は全件「2次以降」。そのため予算区分は無し（1次のときだけ必要な項目のため）。
 *   - 光ADはチェックなし（元データに列が無いため）。
 *   - 鈴木真矢は退職済みのため、採用者になっている1件（西澤克輝）は採用者を空欄にして
 *     直営業扱いにする。稼働スタッフとしての1件はそのまま登録する。
 */
...
//     7稼働日数 8キャリア 9屋号 10店舗名 11請求単価(月) 12支払単価(月)
$DATA = [
    ['プレイス','竹内陽','','','自社外注','','山根脩平',21,'','ED','安城',450000,300000],
    ['プレイス','竹内陽','','','自社外注','','鈴木真矢',21,'','ED','安城',450000,300000],
    ['プレイス','竹内陽','','','自社外注','','押野俊太郎',21,'','YMD','名古屋本店',450000,300000],
    ['プレイス','竹内陽','','','自社外注','','後藤太一',21,'','ED','安城',450000,300000],
    ['プレイス','竹内陽','','','自社外注','','名倉雅貴',21,'SB','','安城住吉',470000,300000],
    ['プレイス','竹内陽','','','自社外注','','綾部航介',21,'SB','','美濃加茂',470000,400000],
    ['プレイス','竹内陽','','綾部航介','自社外注','','田中哲史',21,'SB','','知立',470000,290000],
    ['プレイミー','名倉雅貴','名倉雅貴','','自社外注','','日置航暉',21,'SB','','半田亀崎',420000,336000],
    ['humanR','綾部航介','綾部航介','','アライアンス','NextAssist','浅井貴広',21,'','YMD','北方',420000,399000],
    ['プレイス','竹内陽','','','自社外注','','山内文月',21,'SB','','多治見南',470000,300000],
    ['プレイス','竹内陽','','','正社員','','小栗瑞貴',21,'SB','','芥見',470000,300000],
    ['ラネット','竹内陽','竹内陽','','自社外注','','竹内丈治',21,'SB','','安城',514500,330000],
    ['ラネット','竹内陽','竹内陽','','自社外注','','東郷光啓',21,'SB','','知立',630000,400000],
    ['ラネット','竹内陽','竹内陽','','正社員','','倉地樂',21,'SB','','GA知立',630000,450000],
    ['LANGIS','竹内陽','','','個人外注','','鈴木拓弥',21,'SB','','平針',420000,399000],
    ['クラウドエージェント','竹内陽','東郷光啓','','アライアンス','ネクストプレイス','石川海里',21,'SB','','長久手',441000,420000],
    ['ラネット','竹内陽','','','自社外注','','竹内陽',10,'SB','','中津川',400000,500000],
    ['プレイス','竹内陽','','近藤航','自社外注','','清水一平',21,'SB','','安城',470000,300000],
    ['LANGIS','竹内陽','','','個人外注','','飛田拓斗',21,'SB','','AT各務原鵜沼',409500,315000],
    ['ラネット','竹内陽','','','正社員','','佐藤思杰',21,'SB','','碧南',525000,260000],
    ['プレイス','竹内陽','竹内陽','','アライアンス','T-Group','宮島航希',21,'SB','','碧南',470000,409500],
    ['プレイス','竹内陽','綾部航介','','アライアンス','ASXEED','山口大士',21,'SB','','GA知立',470000,450000],
    ['プレイス','竹内陽','綾部航介','','アライアンス','ASXEED','増岡あかり',21,'','ED','安城',450000,420000],
    ['ラネット','竹内陽','','','アライアンス','小林幹汰','長岡拓也',21,'SB','','AM豊川',525000,483000],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','渡邉拓斗',20,'SB','','GA知立',500000,435000],
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','小木曽太一',16,'SB','','AM豊川',400000,344000],
    ['LANGIS','竹内陽','','近藤航','自社外注','','丹後心来',21,'SB','','一宮開明',399000,250000],
    // 西澤克輝: 元データの採用者は鈴木真矢だが、退職済みのため採用者を空欄にして直営業扱いにする（ユーザー指示）
    ['プレイス','竹内陽','','','自社外注','','西澤克輝',21,'','ED','安城',450000,250000],
    ['プレイス','竹内陽','竹内陽','','アライアンス','T-Group','石谷悠真',21,'','ED','安城',450000,399000],
    ['waplus','竹内陽','','綾部航介','自社外注','','堀恭彰',21,'SB','','モレラ岐阜',462000,315000],
    ['センターフロー','綾部航介','綾部航介','','アライアンス','高田夢斗','高田夢斗',21,'','ED','千音寺',440000,420000],
    ['プレイス','竹内陽','綾部航介','','アライアンス','U-plus','加藤洋亮',21,'','JS','大垣',360000,336000],
    ['プレイス','竹内陽','綾部航介','','アライアンス','東峰グループ','長井優斗',21,'SB','','トップガン',450000,399000],
    ['ラネット','竹内陽','','','自社外注','','田中敦之',21,'SB','','碧南',514500,330000],
    ['waplus','綾部航介','綾部航介','','アライアンス','Pachira','柴田一心',21,'SB','','岡崎南',457800,378000],
    ['ラネット','竹内陽','竹内陽','','アライアンス','ASB','大石託実',21,'SB','','AM豊川',525000,420000],
];
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_regular_202512 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && verifyCsrfToken($_POST['csrf'] ?? '')) {
    ...
    foreach ($DATA as $d) {
        [$clientName, $salesRep, $manager, $recruiter, $workerType, $allianceName,
         $workerName, $days, $carrier, $tradeName, $storeName, $priceIn, $priceOut] = $d;
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_regular_202512.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・<strong>SB はキャリア</strong>、<strong>ED・YMD・JS は屋号</strong>に登録（キャリアの選択肢に無いため）<br>
      ・スタッフ区分の「外注」は<strong>個人外注</strong>として登録<br>
      ・区分は全件<strong>2次以降</strong>（予算区分は1次のときだけの項目なので設定なし）<br>
      ・光ADはチェックなし、終了月・備考は空欄<br>
      ・<strong>西澤克輝</strong>の採用者は元データでは鈴木真矢ですが、退職済みのため<strong>空欄（直営業）</strong>で登録します<br>
  ...
  <div class="alert alert-warning small">
    ...
    <strong>登録後の注意：</strong>稼働日数が21未満の3件（竹内陽10日・渡邉拓斗20日・小木曽太一16日）は、
    ...
    <table class="table table-sm table-hover bg-white mb-0">
      <thead class="table-light" style="position:sticky;top:0">
        <tr>
          ...
          <th>スタッフ</th><th>ｷｬﾘｱ</th><th>屋号</th><th>店舗</th><th class="text-end">稼働</th>
          <th class="text-end">請求単価(月)</th><th class="text-end">支払単価(月)</th><th class="text-end">粗利</th>
        </tr>
      </thead>
      <tbody>
