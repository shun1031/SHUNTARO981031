<?php
/**
 * 【一度だけ実行するスクリプト】2026年1月 常勤案件 データ投入
 *
 * スプレッドシートの「2026年1月稼働分」42件を常勤案件として登録します。
 *
 ...
 *   - 取引先が「光AD」の3件は、取引先を「プレイス」にして光ADチェックをONにする。
 *   - 元データ8列目の日付は稼働開始日。開始月には使わず（使うと12月の案件になってしまう）、
 *     備考に「稼働開始 YYYY/MM」として残す。開始月は全件 2026/01。
 *   - 一番右の日付列（契約終了日）は今回使わない。終了月は空欄。
 */
...
$DATA = [
    ...
    ['プレイス','竹内陽','','','自社外注','','鈴木真矢',21,'','ED','安城',450000,300000,0,'稼働開始 2025/12'],
    ...
    ['プレイス','竹内陽','綾部航介','','アライアンス','ASXEED','山口大士',21,'SB','','GA知立',470000,450000,0,'稼働開始 2025/12'],
    ...
    ['LANGIS','竹内陽','','近藤航','自社外注','','丹後心来',21,'SB','','一宮開明',399000,250000,0,'稼働開始 2025/12'],
    ['プレイス','竹内陽','竹内陽','','アライアンス','T-Group','石谷悠真',21,'','ED','安城',450000,399000,0,'稼働開始 2025/12'],
    ['プレイス','竹内陽','綾部航介','','アライアンス','U-plus','加藤洋亮',21,'','JS','大垣',360000,336000,0,'稼働開始 2025/12'],
    ['プレイス','竹内陽','綾部航介','','アライアンス','東峰グループ','長井優斗',21,'SB','','トップガン',450000,399000,0,'稼働開始 2025/12'],
    ['プレイス','竹内陽','綾部航介','','アライアンス','東峰グループ','安樂斐悠馬',21,'SB','','岐南',470000,378000,1,'稼働開始 2026/01'],
    ['Pachira','綾部航介','綾部航介','','アライアンス','LaXum','池田琉風',20,'docomo','','イオン千種',320000,300000,0,'稼働開始 2026/01'],
    ...
    ['プレイス','竹内陽','','','個人外注','','小林友裕',21,'','AM','モレラ岐阜',470000,350000,1,'稼働開始 2026/01'],
    ['プレイス','竹内陽','','','個人外注','','安山祐亮',21,'SB','','知立',470000,336000,0,'稼働開始 2026/01'],
    ['waplus','綾部航介','綾部航介','','アライアンス','Pachira','柴田一心',21,'SB','','岡崎南',457800,378000,0,'稼働開始 2025/12'],
    ...
    ['テレニシ','竹内陽','','綾部航介','自社外注','','田中哲史',20,'SB','','モレラ岐阜',500000,320000,0,'稼働開始 2026/01'],
    ['プレイス','竹内陽','','','自社外注','','名倉雅貴',21,'SB','','モレラ岐阜',470000,300000,1,'稼働開始 2026/01'],
    ['テレニシ','竹内陽','','','正社員','','小栗瑞貴',20,'SB','','モレラ岐阜',500000,300000,0,'稼働開始 2026/01'],
    ['プレイス','竹内陽','','','自社外注','','竹内丈治',21,'SB','','碧南',470000,330000,0,'稼働開始 2026/01'],
    ['ラネット','竹内陽','','近藤航','自社外注','','清水一平',21,'SB','','碧南',514500,300000,0,'稼働開始 2026/01'],
    ['テレニシ','竹内陽','','','正社員','','佐藤思杰',24,'SB','','岐南',696000,260000,0,'稼働開始 2026/01'],
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_regular_202601 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_regular_202601.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・元データで取引先が「光AD」の<strong><?= $hikariCount ?>件</strong>（安樂斐悠馬・小林友裕・名倉雅貴）は、
        取引先を<strong>プレイス</strong>にして<strong>光ADチェックをON</strong>で登録<br>
      ・元データ8列目の日付は<strong>稼働開始日</strong>なので、備考に「稼働開始 2025/12」の形で記録（開始月は全件2026/01）<br>
      ・一番右の日付列（契約終了日）は<strong>使いません</strong>。終了月は空欄<br>
  ...
  <div class="alert alert-warning small">
    ...
    <strong>登録後の注意：</strong>稼働日数が21未満の6件（竹内陽10日・渡邉拓斗20日・池田琉風20日・田中哲史20日・小栗瑞貴20日・青木大輝1日）は、
