<?php
/**
 * 【一度だけ実行するスクリプト】2026年2月 常勤案件 データ投入
 *
 * スプレッドシートの「2026年2月稼働分」45件を常勤案件として登録します。
 *
 ...
 *     備考に「稼働開始 YYYY/MM」として残す。開始月は全件 2026/02。
...
$DATA = [
    ...
    ['ラネット','竹内陽','竹内陽','','アライアンス','渡邊拓斗','小木曽太一',16,'SB','','豊川八幡',400000,344000,0,'稼働開始 2026/02'],
    ...
    ['テレニシ','竹内陽','','','正社員','','小栗瑞貴',21,'SB','','モレラ岐阜',525000,300000,0,'稼働開始 2026/02'],
    ['テレニシ','竹内陽','','','正社員','','佐藤思杰',21,'SB','','岐南',609000,260000,0,'稼働開始 2026/02'],
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_regular_202602 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_regular_202602.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・元データ8列目の日付は<strong>稼働開始日</strong>なので、備考に「稼働開始 2025/12」の形で記録（開始月は全件2026/02）<br>
      ・管理者・採用者の「該当者なし」は<strong>空欄（直営業）</strong>にして登録（ラネット／ADラダーの1件）<br>
  ...
  <div class="alert alert-warning small">
    ...
    <strong>登録後の注意：</strong>稼働日数が21未満の5件（竹内陽10日・渡邉拓斗20日・池田琉風20日・小木曽太一16日・青木大輝1日）は、
