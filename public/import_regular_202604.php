<?php
/**
 * 【一度だけ実行するスクリプト】2026年4月 常勤案件 データ投入
 *
 * スプレッドシートの「2026年4月稼働分」35件を常勤案件として登録します。
 *
 ...
 *     備考に「稼働開始 YYYY/MM」として残す。開始月は全件 2026/04。
...
$DATA = [
    ...
    ['プレイス','竹内陽','','','正社員','','佐藤思杰',21,'SB','','安城',470000,260000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','','自社外注','','名倉雅貴',21,'SB','','GA知立',470000,300000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','','自社外注','','押野俊太郎',21,'SB','','安城住吉',470000,290000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','綾部航介','個人外注','','田中哲史',21,'SB','','サンロード',470000,336000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','佐藤思杰','個人外注','','佐藤悠太',21,'','ED','安城',450000,252000,0,'稼働開始 2026/04'],
    ['LANGIS','竹内陽','','竹内陽','個人外注','','倉地樂',21,'SB','','イーアス春日井',546000,409500,0,'稼働開始 2026/04'],
    ['LANGIS','竹内陽','','竹内陽','個人外注','','竹内丈治',21,'SB','','カメリアガーデン幸田',504000,378000,0,'稼働開始 2026/04'],
    ['LANGIS','竹内陽','','竹内陽','個人外注','','小栗瑞貴',21,'SB','','鈴鹿',483000,362250,0,'稼働開始 2026/04'],
    ['LANGIS','竹内陽','綾部航介','','アライアンス','Pachira','柴田一心',21,'SB','','アイモール三好',462000,441000,0,'稼働開始 2026/04'],
    ['LANGIS','竹内陽','','近藤航','自社外注','','丹後心来',21,'SB','','野並',441000,300000,0,'稼働開始 2026/04'],
    ['クラウドエージェント','竹内陽','','','個人外注','','安山祐亮',21,'SB','','ららぽーと安城',441000,336000,0,'稼働開始 2026/04'],
    ['クラウドエージェント','竹内陽','','','個人外注','','小林友裕',21,'SB','','共和',441000,350000,0,'稼働開始 2026/04'],
    ['waplus','綾部航介','綾部航介','','アライアンス','東峰グループ','安樂斐悠馬',21,'SB','','一宮妙興寺',441000,378000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','','アライアンス','T-Group','石谷悠真',21,'SB','','多治見南',470000,399000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','','自社外注','','東郷光啓',21,'SB','','知立',470000,290000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','','個人外注','','田中敦之',21,'SB','','碧南',470000,352500,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','','','自社外注','','山内文月',21,'','ED','安城',450000,336000,0,'稼働開始 2026/04'],
    ['プレイス','竹内陽','綾部航介','','アライアンス','U-plus','長井優斗',21,'SB','','TG',492000,420000,0,'稼働開始 2026/04'],
];
...
foreach (array_keys($roles) as $personName) {
    ...
    try {
        ...
        error_log('[import_regular_202604 roster] ' . $e->getMessage());
    }
    $rosterRows[] = $row;
}
...
<?php if ($done): ?>
  ...
  <div class="alert alert-warning mt-3 mb-0 small">
    <i class="bi bi-exclamation-triangle me-1"></i>登録が終わったら、このページ（import_regular_202604.php）は削除してください。もう一度開いて実行すると二重登録の原因になります。
  </div>
...
<?php else: ?>
  ...
  <div class="alert alert-info">
    ...
    <div class="small mt-1" style="line-height:1.9">
      ...
      ・今月は取引先が「光AD」の行が無いため、<strong>光ADチェックは全件OFF</strong>（3月分と同じ）<br>
      ・元データ8列目の日付は<strong>稼働開始日</strong>なので、備考に「稼働開始 2025/12」の形で記録（開始月は全件2026/04）<br>
  ...
  <div class="alert alert-warning small">
    ...
    <strong>登録後の注意：</strong>稼働日数が21未満の2件（竹内陽10日・青木大輝1日）は、
