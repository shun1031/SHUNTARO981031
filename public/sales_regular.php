    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                <a href="?<?= http_build_query(array_merge($_GET, ['export' => 1])) ?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-download me-1"></i>CSV</a>
            ...
            <table class="table sales-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th>スタッフ</th>
                        <th>キャリア/店舗</th>
                        <th class="text-end">請求(月)</th>
                        <th class="text-end">支払(月)</th>
                ...
                <tbody>
                    <?php if (empty($cases)): ?>
                    <tr><td colspan="13" class="text-center text-muted py-4">案件がありません</td></tr>
                    <?php endif; ?>
                    <?php foreach ($cases as $c): ?>
                    <tr class="<?= $c['status'] === 'cancelled' ? 'table-secondary' : '' ?>">
                        <td class="small fw-medium"><?= $c['case_month'] ?>月</td>
                ...
                <tfoot>
                    <tr class="fw-bold" style="background:#f0fdf4">
                        <td colspan="9" class="text-end">合計</td>
